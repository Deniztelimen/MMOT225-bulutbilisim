      ...
      <SafeAreaView style={styles.safearea}>
        <View style={styles.ust}>
          <TouchableOpacity onPress={() => this.MarmaraGetir()}>
            <Text style={styles.bolgeler}>Marmara Bolgesi</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={() => this.EgeGetir()}>
            <Text style={styles.bolgeler}>Ege Bolgesi</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={() => this.AkdenizGetir()}>
            <Text style={styles.bolgeler}>Akdeniz Bolgesi</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={() => this.IcAnadoluGetir()}>
            <Text style={styles.bolgeler}>Ic Anadolu Bolgesi</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={() => this.DoguAnadoluGetir()}>
            <Text style={styles.bolgeler}>Dogu Anadolu Bolgesi</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={() => this.GuneyDoguAnadoluGetir()}>
            <Text style={styles.bolgeler}>Guney Dogu Anadolu Bolgesi</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={() => this.KaradenizGetir()}>
            <Text style={styles.bolgeler}>Karadeniz Bolgesi</Text>
          </TouchableOpacity>
        </View>
